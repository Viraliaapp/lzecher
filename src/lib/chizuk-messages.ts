...
export const CHIZUK_MESSAGES: ChizukMessage[] = [
  ...
  // ── first_checkin ─────────────────────────────────────────────────────────
  {
    ...
    en: 'First daily mark. Your commitment is not only a promise — it is a real act l\'iluy nishmas {name}.',
  ...
  },
  {
    ...
    en: 'One hundred percent. Every portion taken and learned. This community did something rare — kept its commitment to the end, in honor of {name}\'s neshama.',
  ...
  // ── generic_checkin ───────────────────────────────────────────────────────
  {
    ...
    en: 'Today\'s learning is marked. Your consistency is what matters most — not perfection.',
