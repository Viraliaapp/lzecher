...
export const MITZVAH_TEMPLATES: MitzvahTemplate[] = [
  {
    id: "kabbalas-shabbos-early",
    title: "Accepting Shabbos 10 Minutes Early",
    titleHebrew: "קבלת שבת 10 דקות מוקדם",
    description: "Accept Shabbos 10 minutes before the zman in their memory",
    descriptionHebrew: "לקבל שבת 10 דקות לפני הזמן לעילוי נשמתם",
    category: "middot",
  },
  {
    id: "anias-amen",
    title: "Answering Amen with Kavana",
    titleHebrew: "עניית אמן בכוונה",
    description: "Answer Amen with full focus and intention in their memory",
    descriptionHebrew: "לענות אמן בכוונה לעילוי נשמתם",
    category: "tefillah",
  },
  {
    id: "shemiras-halashon",
    title: "Learning Shemiras HaLashon",
    titleHebrew: "לימוד שמירת הלשון",
    description: "Study the laws of guarding one's speech in their memory",
    descriptionHebrew: "ללמוד הלכות שמירת הלשון לעילוי נשמתם",
    category: "limud",
  },
  {
    id: "tzedakah-lzecher",
    title: "Giving Tzedakah L'iluy Nishmas",
    titleHebrew: "נתינת צדקה לעילוי נשמת",
    description: "Give tzedakah in their memory to elevate their soul",
    descriptionHebrew: "לתת צדקה לעילוי נשמתם",
    category: "tzedakah",
  },
  {
    id: "lehodos-lashem",
    title: "Thanking Hashem",
    titleHebrew: "להודות להשם",
    description: "Express hakaras hatov to Hashem in their memory",
    descriptionHebrew: "להודות להשם על כל הטוב לעילוי נשמתם",
    category: "tefillah",
  },
  {
    id: "kabbalah-ishit",
