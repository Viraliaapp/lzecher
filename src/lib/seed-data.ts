...
export const MUSSAR_SEFORIM: MussarSefer[] = [
  ...
  {
    id: "mussar_daily",
    name: "Daily Mussar Learning",
    nameHebrew: "לימוד מוסר כל יום",
    author: "",
    authorHebrew: "",
    units: 1,
    unitType: "daily commitment",
    unitTypeHebrew: "התחייבות יומית",
    description: "Commit to learning mussar each day in their memory. Choose any sefer that speaks to you — Mesilas Yesharim, Chovos HaLevavos, Orchos Tzaddikim, Pirkei Avos, or any other classic work. Even a few minutes daily creates immense zechus.",
    descriptionHebrew: "קבלה ללימוד מוסר מדי יום לעילוי נשמתם. בחרו ספר שמדבר אליכם — מסילת ישרים, חובות הלבבות, אורחות צדיקים, פרקי אבות, או כל ספר קלאסי אחר. אפילו דקות ספורות מדי יום יוצרות זכות עצומה.",
  },
];
