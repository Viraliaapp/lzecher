...
export const MASECHTOS: Masechet[] = [
  ...
  { id: "terumos", name: "Terumos", nameHebrew: "תרומ��ת", seder: "Zeraim", sederHebrew: "זרעים", order: 6, perakim: 11, mishnayot: 86 },
  { id: "maasros", name: "Maasros", nameHebrew: "��עשרות", seder: "Zeraim", sederHebrew: "זרעים", order: 7, perakim: 5, mishnayot: 39 },
  ...
  { id: "pesachim", name: "Pesachim", nameHebrew: "פסחים", seder: "Moed", sederHebrew: "��ועד", order: 14, perakim: 10, mishnayot: 88 },
  ...
  { id: "moed-katan", name: "Moed Katan", nameHebrew: "מועד קטן", seder: "Moed", sederHebrew: "מוע��", order: 22, perakim: 3, mishnayot: 24 },
  ...
  { id: "sotah", name: "Sotah", nameHebrew: "סוטה", seder: "Nashim", sederHebrew: "נש��ם", order: 28, perakim: 9, mishnayot: 60 },
  ...
  { id: "bechoros", name: "Bechoros", nameHebrew: "בכורות", seder: "Kodashim", sederHebrew: "ק��שים", order: 44, perakim: 9, mishnayot: 62 },
  ...
  { id: "tevul-yom", name: "Tevul Yom", nameHebrew: "טבול יום", seder: "Tahorot", sederHebrew: "��הרות", order: 61, perakim: 4, mishnayot: 19 },
  { id: "yadayim", name: "Yadayim", nameHebrew: "ידים", seder: "Tahorot", sederHebrew: "טהרו��", order: 62, perakim: 4, mishnayot: 21 },
...
export const PARSHIYOT: Parsha[] = [
  ...
  { id: "chayei-sarah", name: "Chayei Sarah", nameHebrew: "חיי שרה", book: "Bereishis", bookHebrew: "בראש��ת", order: 5, aliyot: 7 },
  ...
  { id: "mishpatim", name: "Mishpatim", nameHebrew: "מש��טים", book: "Shemos", bookHebrew: "שמות", order: 18, aliyot: 7 },
  ...
  { id: "vayakhel", name: "Vayakhel", nameHebrew: "��יקהל", book: "Shemos", bookHebrew: "שמות", order: 22, aliyot: 7 },
  ...
  { id: "acharei-mos", name: "Acharei Mos", nameHebrew: "אחרי מות", book: "Vayikra", bookHebrew: "ויקר��", order: 29, aliyot: 7 },
  ...
  { id: "shelach", name: "Shelach", nameHebrew: "ש��ח", book: "Bamidbar", bookHebrew: "במדבר", order: 37, aliyot: 7 },
...
export const MITZVAH_TEMPLATES: MitzvahTemplate[] = [
  ...
  { id: "tefillah-extra-tehillim", title: "Extra Tehillim", titleHebrew: "תהילים נו��פים", description: "Say additional chapters of Tehillim daily", descriptionHebrew: "לומר פרקי תהילים נוספים כל יום", category: "tefillah" },
